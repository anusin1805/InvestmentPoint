...
-1 != AmCharts.navigator.indexOf("msie") && (AmCharts.IEversion = parseInt(AmCharts.navigator.split("msie")[1]),
...
AmCharts.isIE = !0,
AmCharts.isModern || (AmCharts.dx = 0,
AmCharts.dy = 0));
...
AmCharts.makeChart = function(a, b) {
    var c = b.type
      , d = b.theme;
    AmCharts.isString(d) && (d = AmCharts.themes[d],
    b.theme = d);
    var e;
    switch (c) {
    case "serial":
    ...
    if (a) {
        ...
        if (0 !== b)
            if ("[object Array]" === Object.prototype.toString.call(a))
                ...
                try {
                    for (c in a)
                        a[c] && ("object" == typeof a[c] && AmCharts.deleteObject(a[c], b - 1),
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    updateData: function() {
        ...
        this.synchronizationMultiplier && this.synchronizeWith ? (AmCharts.isString(this.synchronizeWith) && (this.synchronizeWith = a.getValueAxisById(this.synchronizeWith)),
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum))
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                2 < u && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1,
                p = Math.round(Math.log(this.minReal) * Math.LOG10E),
                r > this.gridCountR && (n = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                var q = 0;
                ...
                if (0 < A) {
                    ...
                    for (d = this.fillAlpha = 0; d < A; d++) {
                        var C = w[d]
                          , y = NaN
                          , z = C.above;
                        isNaN(C.toValue) || (y = this.getCoordinate(C.toValue),
                        s = new this.axisItemRenderer(this,y,"",!0,NaN,NaN,C),
                        this.pushAxisItem(s, z));
                        var J = NaN;
                        isNaN(C.value) || (J = this.getCoordinate(C.value),
                        s = new this.axisItemRenderer(this,J,C.label,!0,NaN,(y - J) / 2,C),
                        this.pushAxisItem(s, z));
                        isNaN(y - J) || (s = new this.guideFillRenderer(this,J,y,C),
                        this.pushAxisItem(s, z),
                        s = s.graphics(),
                        C.graphics = s,
                ...
                for (d = p; d < r; d += n)
                    ...
                    !this.integersOnly || Math.round(p) == p)
                        if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
                            ...
                            s = s + "e" + c,
                            0 === p && (s = "0"),
                            1 == p && (s = "1")) : (h && (s = String(p).split("."),
                            v.precision = s[1] ? s[1].length : -1),
                            s = this.usePrefixes ? AmCharts.addPrefix(p, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, v, !0) : AmCharts.formatNumber(p, v, v.precision));
                            ...
                            if (p == this.baseValue && "radar" != a.type) {
                                ...
                                s = this.viX;
                                C = this.viY;
                                "H" == this.orientation ? 0 <= c && c <= z + 1 && (B = [c, c, c + e],
                                Z = [y, 0, f]) : 0 <= c && c <= y + 1 && (B = [0, z, z + e],
                                Z = [c, c, c + f]);
                                B && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1),
                                c = AmCharts.line(a.container, B, Z, this.gridColor, c, 1, this.dashLength),
                                c.translate(s, C),
                                this.grid0 = c,
                                a.axesSet.push(c),
                                c.toBack())
            ...
            d = this.labelsSet;
            this.positionTitle();
            "radar" != a.type ? (a = this.viX,
            e = this.viY,
            b.translate(a, e),
            d.translate(a, e)) : h.toFront();
    ...
    stackGraphs: function(a) {
        ...
        for (k = this.start; k <= this.end; k++) {
            ...
            for (n = 0; n < h.length; n++)
                ...
                !isNaN(g)))) {
                    ...
                    l.values.close = g,
                    l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k],
                    l.values.open = c[k],
                    c[k] = l.values.close)),
                    "column" != a || isNaN(g) || (l.values.close = g,
                    0 > g ? (l.values.close = g,
                    isNaN(d[k]) ? l.values.open = p : (l.values.close += d[k],
                    l.values.open = d[k]),
                    d[k] = l.values.close) : (l.values.close = g,
                    isNaN(e[k]) ? l.values.open = p : (l.values.close += e[k],
                    l.values.open = e[k]),
                    e[k] = l.values.close)))
                }
        }
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++)
                ...
                isNaN(e[k]) && (e[k] = 0),
                0 > c ? (l.values.close = AmCharts.fitToBounds(c + d[k], -100, 100),
                l.values.open = d[k],
                d[k] = l.values.close) : (l.values.close = AmCharts.fitToBounds(c + e[k], -100, 100),
                l.values.open = e[k],
                e[k] = l.values.close)))))
    },
                ...
                if (e.hasOwnProperty(f)) {
                    ...
                    if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                        ...
                        if (this.minMaxField)
                            ...
                            for (var k in g)
                                g.hasOwnProperty(k) && "percents" != k && "total" != k && (h = g[k],
                                h < c && (c = h))
                    }
                }
        }
                ...
                if (c.hasOwnProperty(d)) {
                    ...
                    if (e.includeInMinMax && (!e.hidden || this.includeHidden)) {
                        ...
                        if (this.minMaxField)
                            ...
                            for (var g in e)
                                e.hasOwnProperty(g) && "percents" != g && "total" != g && (f = e[g],
                                f > a && (a = f))
                    }
                }
        }
    ...
    getCoordinate: function(a) {
        ...
        var b = this.rotate
          ...
          , f = this.min
          , g = this.minReal;
        !0 === this.logarithmic ? (a = Math.log(a) * Math.LOG10E - Math.log(g) * Math.LOG10E,
...
AmCharts.RecAxis = AmCharts.Class({
    construct: function(a) {
        var b = a.chart
          ...
          , n = a.viW
          , p = b.container;
        "H" == a.orientation ? (d = AmCharts.line(p, [0, n], [0, 0], d, e, c),
        this.axisWidth = a.width,
        "bottom" == a.position ? (a = c / 2 + f + m + l - 1,
        c = k) : (a = -c / 2 - f + l + h,
        c = g + k)) : (this.axisWidth = a.height,
        "right" == a.position ? (d = AmCharts.line(p, [0, 0, -g], [0, m, m - h], d, e, c),
        a = l + h,
        c = c / 2 + f + g + n + k - 1) : (d = AmCharts.line(p, [0, 0], [0, m], d, e, c),
        a = l,
        c = -c / 2 - f + k));
        d.translate(c, a);
        b.axesSet.push(d);
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k, l) {
        ...
        g.position && (ea = g.position)) : "" === c && (s = 0);
        W = "start";
        e && (W = "middle");
        var aa = B * Math.PI / 180, ha, G = 0, D = 0, ia = 0, P = ha = 0;
        "V" == Fa && (B = 0);
        var x;
        I && (x = a.autoWrap && 0 === B ? AmCharts.wrappedText(r, c, p, m, n, W, h, e, 0) : AmCharts.text(r, c, p, m, n, W, h),
        P = x.getBBox().width);
        if ("H" == Fa) {
            if (0 <= b && b <= V + 1 && (0 < s && 0 < v && b + k <= V + 1 && (Y = AmCharts.line(r, [b + k, b + k], [0, s], t, v, A),
            u.push(Y)),
            0 < w && (W = AmCharts.line(r, [b, b + da, b + da], [L, L + X, X], C, w, A, y),
            u.push(W))),
            D = 0,
            G = b,
            g && 90 == B && (G -= n),
            ...
            e && (G += e / 2,
            W = "middle"),
            0 < B && (W = "middle")) : W = "middle",
            1 == Z && 0 < J && !g && !l && $ < V && (d = AmCharts.fitToBounds(b, 0, V),
            $ = AmCharts.fitToBounds($, 0, V),
            ha = d - $,
            0 < ha && (fill = AmCharts.rect(r, ha, a.height, z, J),
            fill.translate(d - ha + da, X),
            u.push(fill))),
            "bottom" == ea ? (D += L + n / 2 + oa,
            S ? 0 < B ? (D = L - P / 2 * Math.sin(aa) - s - 3,
            G += P / 2 * Math.cos(aa)) : 0 > B ? (D -= s + n + 3 + 3 - P / 2 * Math.sin(aa),
            G -= P / 2 * Math.cos(aa)) : D -= s + n + 3 + 3 : 0 < B ? (D = L + P / 2 * Math.sin(aa) + s + 3,
            G -= P / 2 * Math.cos(aa)) : 0 > B ? (D = L + s + 3 - P / 2 * Math.sin(aa) + 2,
            G += P / 2 * Math.cos(aa)) : D += s + q + 3 + 3) : (D += X + n / 2 - oa,
            G += da,
            S ? 0 < B ? (D = P / 2 * Math.sin(aa) + s + 3,
            G -= P / 2 * Math.cos(aa)) : D += s + 3 : 0 < B ? (D = -(P / 2) * Math.sin(aa) - s - 6,
            G += P / 2 * Math.cos(aa)) : D -= s + n + 3 + q + 3),
            "bottom" == ea ? ha = (S ? L - s - 1 : L + q - 1) + oa : (ia = da,
            ha = (S ? X : X - s - q + 1) - oa),
            f && (G += f),
            X = G,
            ...
            0 <= b && b <= L + 1 && (0 < s && 0 < v && b + k <= L + 1 && (Y = AmCharts.line(r, [0, s], [b + k, b + k], t, v, A),
            u.push(Y)),
            0 < w && (W = AmCharts.line(r, [0, da, V + da], [b, b + X, b + X], C, w, A, y),
            u.push(W)));
            W = "end";
            if (!0 === S && "left" == ea || !1 === S && "right" == ea)
                W = "start";
            D = b - n / 2;
            1 == Z && 0 < J && !g && !l && (d = AmCharts.fitToBounds(b, 0, L),
            $ = AmCharts.fitToBounds($, 0, L),
            aa = d - $,
            fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, aa, aa], z, J),
            ...
            D += X)) : (G += -s - q - 4 - 2 - oa,
            D -= 2);
            Y && ("right" == ea ? (ia += da + oa + V,
            ha += X,
            ia = S ? ia - q : ia + q) : (ia -= oa,
            S || (ia -= s + q)));
            f && (D += f);
            S = -3;
            "right" == ea && (S += X);
            x && (D > L + 1 || D < S) && (x.remove(),
            x = null)
        }
        Y && Y.translate(ia, ha);
        !1 === a.visible && (Y && Y.remove(),
        x && (x.remove(),
        x = null));
        x && (x.attr({
            "text-anchor": W
...
AmCharts.RecFill = AmCharts.Class({
    construct: function(a, b, c, d) {
        ...
        a.translate(e, b - h + f)) : (a = AmCharts.rect(k, c, a.height, d, l),
        a.translate(b - h + e, f));
        this.set = k.set([a])
    },
    graphics: function() {
...
AmCharts.AmChart = AmCharts.Class({
    ...
    write: function(a) {
        ...
        if (d)
            switch (d = this.addLegend(d, d.divId),
            d.position) {
            case "bottom":
                h.appendChild(b);
                h.appendChild(c);
    ...
    addMouseWheel: function() {
        ...
        document.addEventListener("mousewheel", function(b) {
            a.handleWheel.call(a, b)
        }, !1))
    },
    ...
    showBalloonReal: function(a, b, c, d, e) {
        ...
        f.changeColor(b),
        !c || f.fixedPosition ? (f.setPosition(d, e),
        f.followCursor(!1)) : f.followCursor(!0),
        a && f.showBalloon(a))
    },
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    draw: function() {
        ...
        this.bulletSet = d;
        this.scrollbar || (e = a.marginLeftReal,
        a = a.marginTopReal,
        c.translate(e, a),
        d.translate(e, a));
        b = b.set();
        ...
        "xy" == this.chart.type ? this.xAxis.axisCreated && this.yAxis.axisCreated && (c = !0) : this.valueAxis.axisCreated && (c = !0),
    ...
    createSerialGraph: function() {
        ...
        if (!da && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round",
        this.resetBullet = !0),
        Ka || void 0 != Aa)) {
            var Ga = ea;
            Ga > f.max && (Ga = f.max);
        ...
        for (H = Z; H <= S; H++) {
            ...
            if (ta) {
                ...
                var ja = P.x[X.id]
                  ...
                  , ua = ka
                  , wb = 0;
                "left" == this.stepDirection && (wb = (2 * D + Ha * D) / 2,
                ja -= wb);
                "start" == this.pointPosition && (ja -= D / 2 + Math.floor(Ha * D / 2),
                ka = 0,
                ua = Math.floor(D) + Math.floor(Ha * D));
                "end" == this.pointPosition && (ja += D / 2 + Math.floor(Ha * D / 2),
                ...
                Oa = Ba,
                Pa = Ca) : (Q = F = ja,
                isNaN(la) && !this.fillToGraph && (O = Fa));
                R < la && (x.isNegative = !0,
                Ka && (za = Ka),
                Ma && (Qa = Ma),
                void 0 != Aa && (ra = Aa));
                switch (g) {
                case "line":
                    isNaN(R) ? u || (this.drawLineGraph(q, t, T, U),
                    q = [],
                    t = [],
                    T = [],
                    U = []) : (x.isNegative = R < ea ? !0 : !1,
                    q.push(F),
                    t.push(E),
                    ca = F,
                    ga = E,
                    pa = F,
                    qa = E,
                    !Na || isNaN(O) || isNaN(Q) || (T.push(Q),
                    U.push(O)),
                    void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, T, U),
                    q = [F],
                    t = [E],
                    T = [],
                    U = [],
                    ...
                    break;
                case "smoothedLine":
                    isNaN(R) ? u || (this.drawSmoothedGraph(q, t, T, U),
                    q = [],
                    t = [],
                    T = [],
                    U = []) : (x.isNegative = R < ea ? !0 : !1,
                    ...
                    !Na || isNaN(O) || isNaN(Q) || (T.push(Q),
                    U.push(O)),
                    void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawSmoothedGraph(q, t, T, U),
                    q = [F],
                    t = [E],
                    T = [],
                    U = [],
                ...
                case "step":
                    if (!isNaN(R))
                        ...
                        t.push(E + ua),
                        q.push(F),
                        !Na || isNaN(O) || isNaN(Q) || (T.push(w),
                        U.push(O - ka),
                        T.push(Q),
                        U.push(O - ka),
                        T.push(Q),
                        U.push(O + ua))) : (isNaN(s) || (t.push(s),
                        q.push(v),
                        t.push(s),
                        q.push(F - ka)),
                        q.push(F - ka),
                        ...
                        q.push(F + ua),
                        t.push(E),
                        !Na || isNaN(O) || isNaN(Q) || (T.push(Q - ka),
                        U.push(A),
                        T.push(Q - ka),
                        U.push(O),
                        T.push(Q + ua),
                        ...
                        if (1 >= this.periodSpan || 1 < this.periodSpan && F - v > ka + ua)
                            v = s = NaN;
                        this.drawLineGraph(q, t, T, U);
                        q = [];
                        t = [];
                ...
                case "column":
                    ...
                    if (!isNaN(R)) {
                        R < ea ? (x.isNegative = !0,
                        Ka && (za = Ka),
                        void 0 != Aa && (ma = Aa)) : x.isNegative = !1;
                        var xb = f.min
                          , yb = f.max;
                        if (!(R < xb && la < xb || R > yb && la > yb))
                            if (n) {
                                "3d" == I ? (N = E - 0.5 * (h + G) + G / 2 + J * $,
                                M = Q + z * $) : (N = Math.floor(E - (p / 2 - $) * (h + G) + G / 2),
                                M = Q);
                                K = h;
                                ca = F;
                                ga = N + h / 2;
                                ...
                                if (N < l && 0 < K && (na = new AmCharts.Cuboid(e,ba,K,z - a.d3x,J - a.d3y,za,Qa,L,ma,V,ha,r,n,Y,Ra),
                                "bottom" != B && "inside" != B && "middle" != B))
                                    if (B = f.reversed ? "left" : "right",
                                    0 > R)
                                        B = f.reversed ? "right" : "left";
                                    else if ("regular" == I || "100%" == I)
                                        ca += this.dx
                            } else {
                                "3d" == I ? (M = F - 0.5 * (h + G) + G / 2 + z * $,
                                N = O + J * $) : (M = F - (p / 2 - $) * (h + G) + G / 2,
                                N = O);
                                K = h;
                                ca = M + h / 2;
                                ga = E;
                                ...
                                if (M < k + $ * z && 0 < K)
                                    if (na = new AmCharts.Cuboid(e,K,ba,z - a.d3x,J - a.d3y,za,Qa,L,ma,this.lineAlpha,ha,r,n,Y,Ra),
                        ...
                        (x.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"),
                        !da)) {
                            "none" == I && (y = n ? (this.end + 1 - H) * C - c : C * H + c);
                            "3d" == I && (n ? (y = (C - c) * (this.end + 1 - H),
                            ca += z * this.columnIndex,
                            pa += z * this.columnIndex,
                            x.y += z * this.columnIndex) : (y = (C - c) * (H + 1),
                            ca += 3,
                    ...
                    if (!isNaN(la) && !isNaN(R)) {
                        ...
                        if (n) {
                            ...
                            N < l && 0 < K) {
                                ...
                                kb = [Q, Oa]) : (jb = [Q, Pa],
                                kb = [F, Oa]);
                                !isNaN(Pa) && !isNaN(Oa) && E < l && 0 < E && ($a = AmCharts.line(e, jb, [E, E], ma, V, L),
                        ...
                        M < k && 0 < K) {
                            ...
                            mb = [O, Ba]) : (lb = [O, Ca],
                            mb = [E, Ba]);
                            !isNaN(Ca) && !isNaN(Ba) && F < k && 0 < F && ($a = AmCharts.line(e, [F, F], lb, ma, V, L),
                    ...
                    if (this.end - this.start <= Bb || 0 === Bb) {
                        ...
                        if (Cb) {
                            ...
                            case "bottom":
                                ...
                                break;
                            case "middle":
                                "column" == g && (n ? (wa = -(Ea / 2) + this.fontSize / 2,
                                va = -(F - Q) / 2 - z,
                                0 > ba && (va += z),
                                Math.abs(F - Q) < Ia && !this.showAllValueLabels && (fa.remove(),
                                fa = null)) : (wa = -(E - O) / 2,
                                0 > ba && (wa -= J),
                                Math.abs(E - O) < Ea && !this.showAllValueLabels && (fa.remove(),
                                fa = null)));
                                break;
                            case "inside":
                                n ? (wa = -(Ea / 2) + this.fontSize / 2,
                                va = 0 > ba ? Ia / 2 + 6 : -Ia / 2 - 6) : wa = 0 > ba ? Ea : -Ea
                            }
                            if (fa) {
                        ...
                        if ("regular" == I || "100%" == I) {
                            ...
                            if (Fb) {
                                ...
                                "column" != g && (Ua = Da);
                                n ? (Ta = E,
                                Sa = 0 > R ? F - Hb / 2 - 2 - Ua : F + Hb / 2 + 3 + Ua) : (Sa = F,
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(q, t, T, U) : this.drawLineGraph(q, t, T, U),
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            void 0 !== u && (m = AmCharts.line(g, a, b, u, p, m, q, !1, !0),
            k.push(m));
            if (0 < f || 0 < v)
                if (m = a.join(";").split(";"),
                p = b.join(";").split(";"),
                "serial" == e.chart.type && (0 < c.length ? (c.reverse(),
                d.reverse(),
                m = a.concat(c),
                p = b.concat(d)) : e.rotate ? (p.push(p[p.length - 1]),
                m.push(s),
                p.push(p[0]),
                m.push(s),
                p.push(p[0]),
                m.push(m[0])) : (m.push(m[m.length - 1]),
                p.push(s),
                m.push(m[0]),
                p.push(s),
                m.push(a[0]),
                ...
                0 < f && (b = AmCharts.polygon(g, m, p, r, f, 1, "#000", 0, a),
                b.pattern(e.pattern),
                h.push(b)),
                t || void 0 !== u)
                    isNaN(v) && (v = f),
    ...
    drawSmoothedGraph: function(a, b, c, d) {
        if (1 < a.length) {
            ...
            g.push(k.path);
            void 0 !== r && (l = new AmCharts.Bezier(f,a,b,r,v,l,p,0,e),
            h.push(l.path));
            0 < m && (k = a.join(";").split(";"),
            n = b.join(";").split(";"),
            l = "",
            ...
            d.reverse(),
            k = a.concat(c),
            n = b.concat(d)) : (this.rotate ? (l += " L" + t + "," + b[b.length - 1],
            l += " L" + t + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + t,
            l += " L" + a[0] + "," + t),
            l += " L" + a[0] + "," + b[0]),
    ...
    createBullet: function(a, b, c, d) {
        ...
        var h = f;
        this.bulletAxis && (f = a.values.error,
        isNaN(f) || (g = f),
        ...
        var m;
        "xy" == this.chart.type && this.valueField && (m = this.pattern,
        ...
        if (this.customBullet || a.customBullet)
            ...
            m && (k && k.remove(),
            "function" == typeof m ? (k = new m,
            k.chart = this.chart,
            a.bulletConfig && (k.availableSpace = c,
            k.graph = this,
            a.bulletConfig.minCoord = this.minCoord - c,
            k.bulletConfig = a.bulletConfig),
            k.write(d),
            k = k.set) : (this.chart.path && (m = this.chart.path + m),
            k = d.set(),
            d = d.image(m, 0, 0, f, f),
            k.push(d),
            this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
        k && ((a.url || this.showHandOnHover) && k.setAttr("cursor", "pointer"),
        "serial" == this.chart.type && (0 > b - 0 || b - 0 > this.width || c < -f / 2 || c - 0 > this.height) && (k.remove(),
        k = null),
        k && (this.bulletSet.push(k),
        k.translate(b, c),
    ...
    handleRollOver: function(a, b) {
        if (a) {
            ...
            d = this.showBalloon;
            c.chartCursor && "serial" == c.type && (d = !1,
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function() {
        ...
        "right" == d ? e ? g.setBounds(n, p + m, n + r + l, p + u + m) : g.setBounds(n + r + l + f, p + m, n + r + 1E3, p + u + m) : e ? g.setBounds(n, p, r + n, u + p) : g.setBounds(-1E3, -1E3, n - q - f, p + u + 15)) : (g.maxWidth = r,
        c.parseDates && (q = 0,
        g.pointerWidth = 0),
        "top" == d ? e ? g.setBounds(n + l, p + m, r + l + n, u + p) : g.setBounds(n + l, -1E3, r + l + n, p + m - q - f) : e ? g.setBounds(n, p, r + n, u + p - q) : g.setBounds(n, p + u + q + f - 1, n + r, p + u + q + f));
        this.hideCursor()
    },
    ...
    detectMovement: function() {
        ...
        if (a.mouseIsOver) {
            var b = a.mouseX - this.x
              , c = a.mouseY - this.y;
            0 < b && b < this.width && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")),
            this.rolledOver = !0,
    ...
    arrangeBalloons2: function() {
        ...
        for (e = 0; e < f; e++) {
            ...
            var h = g.bottom - g.yPos
              , k = f - e - 1;
            0 < e && b - h < d + 3 && (g.setBounds(c, d + 3, c + this.width, d + h + 3),
    ...
    updateCursor: function(a, b) {
        ...
        this.drawingLine = AmCharts.line(this.container, [this.x + this.drawStartX, this.x + d], [this.y + this.drawStartY, this.y + e], this.cursorColor, 1, 1));
        if (this.enabled) {
            void 0 === b && (b = !0);
            ...
            if (p) {
                ...
                if (c.mouseIsOver || y || z || this.forceShow)
                    ...
                    z) {
                        ...
                        g.chart = this.chart,
                        f.parseDates && !f.equalSpacing ? (c + d > w && (d = w - c),
                        y + d < s && (d = s - y),
                        g.start = y + d,
                        g.end = c + d,
                        this.fire(g.type, g)) : B + d >= this.data.length || 0 > k + d || (g.start = k + d,
                        g.end = B + d,
                        this.fire(g.type, g)))
                    } else {
                        ...
                        0 < this.cursorAlpha && (s = this.line,
                        u ? (w = 0,
                        t = r + h) : (w = r,
                        t = 0),
                        A = this.animationDuration,
                        0 < A && !this.zooming ? isNaN(this.previousX) ? s.translate(w, t) : (s.translate(this.previousX, this.previousY),
                        s.animate({
                            translate: w + "," + t
                        }, A, "easeOutSine")) : s.translate(w, t),
                        this.previousX = w,
                        this.previousY = t,
                        s.show());
                        ...
                        t = !0;
                        y && (t = !1);
                        this.categoryBalloonEnabled && t ? (u ? (q && ("right" == C ? v.setBounds(k, l + h, k + m + g, l + r + h) : v.setBounds(k, l + h, k + m + g, l + r)),
                        "right" == C ? q ? v.setPosition(k + m + g, l + r + h) : v.setPosition(k + m + g + I, l + r + h) : q ? v.setPosition(k, l + r) : v.setPosition(k - I, l + r)) : "top" == C ? q ? v.setPosition(k + r + g, l + h) : v.setPosition(k + r + g, l + h - I + 1) : q ? v.setPosition(k + r, l + n) : v.setPosition(k + r, l + n + I - 1),
                        (s = this.categoryBalloonFunction) ? v.showBalloon(s(p.category)) : f.parseDates ? (f = AmCharts.formatDate(p.category, this.categoryBalloonDateFormat),
                        -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f, p.category)),
                        v.showBalloon(f)) : v.showBalloon(AmCharts.fixNewLines(p.category))) : v.hide();
                        J && this.bulletsEnabled && this.showBullets();
                        if (this.oneBalloonOnly) {
                            h = Infinity;
                            for (w = 0; w < J.length; w++)
                                f = J[w],
                                f.showBalloon && !f.hidden && f.balloonText && (v = p.axes[f.valueAxis.id].graphs[f.id],
                                s = v.y,
                                isNaN(s) || (u ? Math.abs(d - s) < h && (h = Math.abs(d - s),
                                B = f) : Math.abs(e - s) < h && (h = Math.abs(e - s),
                                B = f)));
                        ...
                        if (a != this.previousIndex || B != this.previousMostCloseGraph)
                            ...
                            J && this.valueBalloonsEnabled && t && c.balloon.enabled) {
                                ...
                                for (w = 0; w < J.length; w++)
                                    if (f = J[w],
                                    (!this.oneBalloonOnly || f == B) && f.showBalloon && !f.hidden && f.balloonText && ("step" == f.type && "left" == f.stepDirection && (p = this.data[a + 1]),
                                    p)) {
                                        ...
                                        if (this.showNextAvailable && isNaN(s) && a + 1 < this.data.length)
                                            for (r = a + 1; r < this.data.length; r++)
                                                if (q = this.data[r])
                                                    if (v = q.axes[f.valueAxis.id].graphs[f.id],
                                                    s = v.y,
                                                    !isNaN(s))
                                                        break;
                                        if (!isNaN(s)) {
                                            ...
                                            t.changeColor(C),
                                            void 0 !== f.balloonAlpha && (t.fillAlpha = f.balloonAlpha),
                                            void 0 !== f.balloonTextColor && (t.color = f.balloonTextColor),
                                            t.setPosition(r + k, q + l),
                                            r = c.formatString(f.balloonText, v, !0),
                                            (q = f.balloonFunction) && (r = q(v, f).toString()),
                                            "" !== r && (u ? t.showBalloon(r) : (t.text = r,
                                            t.show = !0)),
                                            !u && t.set && t.set.hide(),
                                            h.push({
                                                yy: s,
        ...
        if (a) {
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan)
                    ...
                    c.chart = a;
                    if ("cursor" == this.type)
                        this.rotate ? this.selectionPosY = e : this.selectionPosX = e = d,
                        2 > Math.abs(e - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex,
                        ...
                        3 > Math.abs(d - g) && 3 > Math.abs(e - h) || (b = Math.min(g, d),
                        f = Math.min(h, e),
                        d = Math.abs(g - d),
                        e = Math.abs(h - e),
    ...
    handleMouseDown: function(a) {
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)
                ...
                this.selectionPosX = this.linePos)) : (this.initialMouseX = d,
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({
    ...
    updateScrollbar: function() {
        ...
        m = p - h,
        a > m && (a = m),
        g.setAttr("y", a)) : (a = m + (r - a),
        0 > a && (a = 0),
        m = n - k,
        a > m && (a = m),
        g.setAttr("x", a))),
        this.resizingRight && (l ? (a = u - d,
        a + d > p + f && (a = p - d + f),
        0 > a ? (this.resizingRight = !1,
        b = this.resizingLeft = !0) : (0 === a && (a = 0.1),
        g.setAttr("height", a))) : (a = r - c,
        a + c > n + e && (a = n - c + e),
        0 > a ? (this.resizingRight = !1,
        b = this.resizingLeft = !0) : (0 === a && (a = 0.1),
        g.setAttr("width", a)))),
    ...
    updateDragIconPositions: function() {
        ...
        e.translate(this.x + (h - g) / 2, this.y + c + a.height - f / 2)) : (f = this.dragIconHeight,
    ...
    dispatchScrollbarEvent: function() {
        if (this.skipEvent)
            ...
            if (f.parseDates && !f.equalSpacing) {
                ...
                f.minDuration(),
                d = Math.round(b / g) + a,
                a = this.dragging ? d + this.timeDifference : Math.round((b + c) / g) + a,
                d > a && (d = a),
            ...
            d != this.start || this.end != b)
                ...
                e.start = this.start,
                e.end = this.end,
                f.parseDates && (a[this.start] && (e.startDate = new Date(a[this.start].time)),
...
AmCharts.AmBalloon = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                A = m.offsetWidth;
                w = m.offsetHeight;
                m.clientHeight && (A = m.clientWidth,
                w = m.clientHeight);
                var w = w + 2 * q
                  , y = A + 2 * u;
                window.opera && (w += 2);
                ...
                d && (b += z),
                z = b + t,
                this.deltaSignY = -1) : (d && (b -= z),
                z = b - w - t,
                this.deltaSignY = 1)) : (2 * t > w && (t = w / 2),
                z = b - w / 2,
                a < g + (k - g) / 2 ? (A = a + t,
                this.deltaSignX = -1) : (A = a - y - t,
                this.deltaSignX = 1));
                z + w >= l && (z = l - w);
                z < h && (z = h);
                A < g && (A = g);
                ...
                0 < s || 0 === t ? (0 < q && (a = AmCharts.rect(e, y, w, n, 0, u + 1, I, q, this.cornerRadius),
                AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4),
                f.push(a)),
                n = AmCharts.rect(e, y, w, n, this.fillAlpha, u, p, this.borderAlpha, this.cornerRadius),
                this.showBullet && (Z = AmCharts.circle(e, B, r, this.fillAlpha),
                f.push(Z))) : (r = [],
                s = [],
                "H" != v ? (g = a - A,
                g > y - t && (g = y - t),
                ...
                s = J ? [0, 0, b - z, 0, 0, w, w, 0] : [w, w, b - z, w, w, 0, 0, w]) : (r = b - z,
                r > w - t && (r = w - t),
                r < t && (r = t),
                s = [0, r - t, b - z, r + t, w, w, 0, 0],
                r = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, y, y, 0] : [y, y, A + y > a ? y : a - A, y, y, 0, 0, y]),
                0 < q && (a = AmCharts.polygon(e, r, s, n, 0, u, I, q),
                a.translate(1, 1),
                f.push(a)),
                n = AmCharts.polygon(e, r, s, n, this.fillAlpha, u, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
                ...
                m && (C.left = this.prevTX + "px",
                C.top = this.prevTY + "px",
                this.xAnim = c.animate({
                    node: m
                }, "left", this.prevTX, l, b, "easeOutSine", "px"),
    ...
    hide: function() {
        ...
        if (0 < b) {
            ...
            a.show = !1;
            var d = a.set;
            d && (d.setAttr("opacity", a.fillAlpha),
            a.fadeAnim1 = d.animate({
                opacity: 0
            }, b, "easeInSine"));
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    parseData: function() {
        ...
        if (void 0 !== b) {
            ...
            for (e = 0; e < a.length; e++)
                c ? g = AmCharts.adjustLuminosity(c, e * d / 100) : (g = this.colors[e],
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    drawZoomOutButton: function() {
        ...
        l && (l.fontSize && (d = l.fontSize),
        l.color && (c = l.color),
        l.backgroundColor && (h = l.backgroundColor),
        isNaN(l.backgroundAlpha) || (a.zoomOutButtonRollOverAlpha = l.backgroundAlpha));
        var p = l = 0;
        void 0 !== a.pathToImages && f && (n = a.container.image(a.pathToImages + f, 0, 0, e, e),
        b.push(n),
        n = n.getBBox(),
        l = n.width + 5);
        void 0 !== g && (c = AmCharts.text(a.container, g, c, a.fontFamily, d, "start"),
        d = c.getBBox(),
    ...
    drawPlotArea: function() {
        ...
        e = AmCharts.polygon(this.container, [0, a, e + a, e, 0], [0, b, b, 0, 0], g, h, 1, k, l),
        e.translate(c, d + f),
        this.set.push(e),
        a = AmCharts.polygon(this.container, [0, 0, a, a, 0], [0, f, f + b, b, 0], g, h, 1, k, l),
        a.translate(c, d),
        this.set.push(a));
    ...
    updateChartCursor: function() {
        var a = this.chartCursor;
        a && (a = AmCharts.processObject(a, AmCharts.ChartCursor, this.theme),
    ...
    processScrollbars: function() {
        ...
        a && (a = AmCharts.processObject(a, AmCharts.ChartScrollbar, this.theme),
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function() {
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, u = a.initialXValue, q = a.finalXValue, t = a.initialValue, v = a.finalValue, s = p.recalculateToPercents, w = b.dataDateFormat;
        h && (k && (k instanceof Date || (k = w ? AmCharts.stringToDate(k, w) : new Date(k)),
        a.initialDate = k,
        d = h.dateToCoordinate(k)),
        l && (d = h.categoryToCoordinate(l)),
        m && (m instanceof Date || (m = w ? AmCharts.stringToDate(m, w) : new Date(m)),
        a.finalDate = m,
        e = h.dateToCoordinate(m)),
        n && (e = h.categoryToCoordinate(n)));
        r && !s && (isNaN(u) || (d = r.getCoordinate(u)),
        isNaN(q) || (e = r.getCoordinate(q)));
        p && !s && (isNaN(t) || (f = p.getCoordinate(t)),
        isNaN(v) || (g = p.getCoordinate(v)));
        isNaN(d) || isNaN(e) || isNaN(f) || isNaN(f) || (b.rotate ? (h = [f, g],
        e = [d, e]) : (h = [d, e],
        e = [f, g]),
        f = a.lineColor,
        ...
        l = n / Math.abs(n),
        m = p / Math.abs(p),
        p = n * p / Math.abs(n * p) * Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2)),
        n = Math.asin(n / p),
        p = 90 * Math.PI / 180 - n,
...
AmCharts.text = function(a, b, c, d, e, f, g, h) {
    ...
    isNaN(h) && (h = 1);
    void 0 !== b && (b = String(b),
    AmCharts.isIE && !AmCharts.isModern && (b = b.replace("&amp;", "&"),
    b = b.replace("&", "&amp;")));
    c = {
        fill: c,
        "font-family": d,
...
AmCharts.polygon = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    var n = d
      , p = !1;
    "object" == typeof n && 1 < n.length && (p = !0,
    n = n[0]);
    void 0 === g && (g = n);
    e = {
        fill: n,
    ...
    m = AmCharts.dx;
    f = AmCharts.dy;
    a.handDrawn && (c = AmCharts.makeHD(b, c, a.handDrawScatter),
    b = c[0],
    c = c[1]);
    g = Math.round;
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    h *= 10,
    r *= 10,
    1 > Math.abs(e) && 1 >= Math.abs(A - s) && 1 >= Math.abs(C - w) && (I = !0));
    e = "";
    var B;
    n && (z["fill-opacity"] = 0,
    z["stroke-opacity"] = l["stroke-opacity"] / 2,
    z.stroke = l.stroke);
    0 < k && (u ? (B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k),
    I || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + s + "," + (w + k) + "," + A + "," + (C + k)),
    B += " L" + y + "," + (t + k),
    0 < h && (I || (B += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + y + "," + (k + t) + "," + q + "," + (k + v)))) : (B = " M" + q + "," + (v + k) + " L" + s + "," + (w + k) + (" A" + f + "," + g + ",0," + J + ",1," + A + "," + (C + k) + " L" + y + "," + (t + k)),
    0 < h && (B += " A" + h + "," + r + ",0," + J + ",0," + q + "," + (v + k))),
    B += " Z",
    B = a.path(B, void 0, void 0, "1000,1000").attr(z),
    d.push(B),
    B = a.path(" M" + q + "," + v + " L" + q + "," + (v + k) + " L" + s + "," + (w + k) + " L" + s + "," + w + " L" + q + "," + v + " Z", void 0, void 0, "1000,1000").attr(z),
    k = a.path(" M" + A + "," + C + " L" + A + "," + (C + k) + " L" + y + "," + (t + k) + " L" + y + "," + t + " L" + A + "," + C + " Z", void 0, void 0, "1000,1000").attr(z),
    d.push(B),
    d.push(k));
    u ? (I || (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + "," + p(c + g) + "," + p(s) + "," + p(w) + "," + p(A) + "," + p(C)),
    f = " M" + p(q) + "," + p(v) + " L" + p(s) + "," + p(w) + e + " L" + p(y) + "," + p(t)) : f = " M" + q + "," + v + " L" + s + "," + w + (" A" + f + "," + g + ",0," + J + ",1," + A + "," + C) + " L" + y + "," + t;
    0 < h && (u ? I || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + y + "," + t + "," + q + "," + v) : f += " A" + h + "," + r + ",0," + J + ",0," + q + "," + v);
    a.handDrawn && (b = AmCharts.line(a, [q, s], [v, w], l.stroke, l.thickness * Math.random() * a.handDrawThickness, l["stroke-opacity"]),
    d.push(b));
...
AmCharts.AmDraw = AmCharts.Class({
    construct: function(a, b, c, d) {
        ...
        if (AmCharts.hasSVG) {
            ...
            e.appendChild(b);
            AmCharts.rtl && (e.setAttribute("direction", "rtl"),
            e.style.left = "auto",
            e.style.right = "0px");
            ...
            e.addRule(".amvml", "behavior:url(#default#VML); display:inline-block; antialias:true"),
...
AmCharts.VMLRenderer = AmCharts.Class({
    ...
    pattern: function(a, b) {
        ...
        8 === document.documentMode ? (c.type = "tile",
        c.src = b.url) : (c.setAttribute("type", "tile"),
        c.setAttribute("src", b.url))
    },
    update: function() {}
});
AmCharts.SVGRenderer = AmCharts.Class({
    ...
    update: function() {
        ...
        for (a = b.length - 1; 0 <= a; a--) {
            ...
            l = Number(k[0]),
            k = Number(k[1]),
            l = 0 === l - g ? l : Math.round(AmCharts[c.effect](0, e, g, l - g, d)),
            c = 0 === k - h ? k : Math.round(AmCharts[c.effect](0, e, h, k - h, d)),
            g = "transform",
            c = "translate(" + l + "," + c + ")") : (k = Number(c.from),
            h = Number(c.to),
            l = h - k,
            c = AmCharts[c.effect](0, e, k, l, d),
            isNaN(c) && (c = h),
            0 === l && this.animations.splice(a, 1)),
            this.setAttr(f, g, c)) : ("translate" == g ? (k = c.to.split(","),
            l = Number(k[0]),
            k = Number(k[1]),
            f.translate(l, k)) : (h = Number(c.to),
            this.setAttr(f, g, h)),
            this.animations.splice(a, 1))
        }
    },
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function() {
        ...
        for (s = 0; s < t.length; s++) {
            ...
            v = y.getBBox();
            var z;
            this.equalWidths ? z = f + A * (p + m + this.markerLabelGap) : (z = C,
            C = C + v.width + f + m);
            z + v.width > n && 0 < s && 0 !== A && (w++,
            A = 0,
            z = f,
            C = z + v.width + f + m);
            y.translate(z, (r + l) * w);
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                ...
                "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)
                    g = k.set(),
                    a.hidden || (d = a.lineColorR,
                    f = a.bulletBorderColorR),
                    n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength),
                    g.push(n),
                    a.bullet && (a.hidden || (d = a.bulletColorR),
                    n = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2),
                    g.push(n)),
                    p = 0,
                    m = l,
                    n = l / 3;
                ...
                h ? (b.path && (h = b.path + h),
                g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
            this.addListeners(g, a);
            k = k.set([g]);
            this.switchable && k.setAttr("cursor", "pointer");
            (f = this.switchType) && "none" != f && ("x" == f ? (r = this.createX(),
            r.translate(l / 2, l / 2)) : r = this.createV(),
            r.dItem = a,
            !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(),
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if (d)
                ...
                if (void 0 !== f.type) {
                    ...
                    g = b.formatString(g, h)) : k && (g = b.formatPeriodString(k, f))
                } else
